...
subtitle: "A styled Quarto manuscript for communication and journalism students"
author:
  - name: "Student Name"
...
format:
  html:
    theme: cosmo
    css: communication_paper_style.css
    toc: true
    toc-depth: 3
    toc-location: left
    ...
    code-fold: true
    smooth-scroll: true
    title-block-banner: "#f2efe8"
    title-block-banner-color: "#202124"
  pdf:
...
::: {.research-summary}
**Research summary.** This teaching example uses a fictional survey to model a
compact empirical paper: a communication theory claim, a testable expectation,
a transparent measure, a labeled table, a cross-referenced figure, and a
numbered Nature-style reference list.
:::
...
: Group means shown in @fig-engagement. {#tbl-means}
...
The pattern in @tbl-means is consistent with H1. The low news-use group has the
lowest mean engagement score, while the high national news-use group has the
highest mean score. Because this is a fictional teaching dataset, the result
should be read as an example of manuscript structure rather than as evidence
about actual student behavior.
